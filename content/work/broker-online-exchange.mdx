...
<figure>
  <img src="/work/broker/interface-restored.png" alt="Reconstructed Broker Online Exchange customer profile and quoting interface" width={1672} height={941} />
  <figcaption>AI-restored illustration based on the public walkthrough, with the presenter overlay removed. Fine UI details may differ; the video below shows the original application.</figcaption>
</figure>
