...
<CaseTLDR
  role="Solo · Product Design + Eng"
  line="A live realtime collaboration room for moodboards and creative review, open at roomboard.online."
  stack="Next.js 16, React 19, Pixi.js, Elixir/Phoenix, Supabase"
>

- Real canvas: cards, connectors, comments, zoom/pan, lock — in Pixi.js
- Phoenix Channels for realtime presence and board events
- Supabase persistence, link-first collaboration, light/dark themes
