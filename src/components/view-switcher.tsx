...
export function ViewSwitcher({
  ...
  return (
    <>
      {/* sticky nav — bg + border each sit one step off the page bg in either
          theme (milky-white / near-black header), driven by the --nav-bg token. */}
      <nav
        className="sticky top-0 z-[120] border-b"
        style={{
          backgroundColor: "var(--nav-bg)",
          borderBottomColor: "color-mix(in oklab, var(--bg), var(--fg) 12%)",
        }}
      >
